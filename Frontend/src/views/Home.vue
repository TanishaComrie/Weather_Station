<template>
  ...
  <VContainer class="fill-height ">
    <VResponsive class="align-center text-center fill-height">
      <VImg height="350" class="mb-5" src="https://gallery.yopriceville.com/var/resizes/Free-Clipart-Pictures/Sun-and-Moon-PNG/Sun_Transparent_PNG_Clip_Art.png?m=1629833462" />


      <h1 class="text-h2 font-weight-bold">ELET2415</h1>
      <h1 class="text-h2 font-weight-bold">WEATHER STATION</h1>
      <div class="text-body-2 font-weight-light mb-n1">Project</div>
